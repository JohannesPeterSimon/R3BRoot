...
ClassImp(R3BTofContFactS473)

    static R3BTofContFactS473 gR3BTofContFact;

R3BTofContFactS473::R3BTofContFactS473()
{
    // Constructor (called when the library is loaded)
    fName = "R3BTofContFactS473";
    fTitle = "Factory for parameter containers in libR3BTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
	//cout << "Correct ContFactS473 called" << endl;
}

void R3BTofContFactS473::setAllContainers()
{
	...
	FairContainer* p2 = new FairContainer("TofdGlobalPar", "TOFd Velocity Parameters", "TestDefaultContext");
	p2->addContext("TestNonDefaultContext");
	containers->Add(p2);
}

FairParSet* R3BTofContFactS473::createContainer(FairContainer* c)
{
	...
	if (strcmp(name, "TofdGlobalPar") == 0)
	{
		p = new R3BTofdGlobalParS473(c->getConcatName().Data(), c->GetTitle(), c->getContext());
	}

	return p;
}

void R3BTofContFactS473::activateParIo(FairParIo* io)
{

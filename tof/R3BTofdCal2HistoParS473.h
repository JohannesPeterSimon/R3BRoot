...
#ifndef R3BTOFDCAL2HISTOPARS473_H
#define R3BTOFDCAL2HISTOPARS473_H
...
#endif
class R3BTofdCal2HistoParS473 : public FairTask
{
  public:
    /**
     * Default constructor.
     ...
     */
    R3BTofdCal2HistoParS473(const char* name, Int_t iVerbose = 1);
    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTofdCal2HistoParS473();
    /**
	...
	/**
	 * Method for setting hard coded walk parameters.
	 */
	virtual void setWalks();
  ...
  public:
    ClassDef(R3BTofdCal2HistoParS473, 1)
};

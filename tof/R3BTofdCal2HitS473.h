...
#ifndef R3BTOFDCAL2HITS473
#define R3BTOFDCAL2HITS473
 ...
 */
class R3BTofdCal2HitS473 : public FairTask
{
  ...
  public:
	...
	{
		Int_t p;			/**< plane. */
		Int_t vb1;			/**< virtual bar. */
		Int_t vb2;			/**< virtual bar of clone. */
		Double_t eloss;		/**< energy loss. */
		Double_t x1;		/**< randomised x position. */
		Double_t x2;		/**< randomised x position of clone. */
		Double_t y;			/**< y position. */
		Double_t t;			/**< time of flight between los and detector plane. */
		//Double_t beta = 0;	/**< beta calculated from hits after this one. */
		Bool_t used = false;		/**< true if hit has already been saved to branch. */	
	};
     ...
     */
    R3BTofdCal2HitS473(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTofdCal2HitS473();
	...
	/**
	 * Method to calculate velocity before the plane
	 */
	virtual Double_t preBeta(Double_t beta, Double_t Eloss);
    /**
     * Method for insert.
     */
	 ...
	 */
	inline void SetGlobal(Bool_t yn){ fGlobal = yn; }
    /**
	...
	/**
	 * Perform cuts on LOS multiplicity
	 */
	inline void SetCutLos(Bool_t yn){fCutLosMult = yn; }
	
	/**
	 *	Method for checking if the hits have overlapping virtual bars
	 */
	virtual  Int_t SameVB(hit*, hit*);
  ...
  private:
    ...
    R3BTofdGlobalParS473* fGlobPar; /**< Tofd global parameter container. */
    ...
    TH2F* fhLosXYP;
	TH1F* fhChargeLos;
	TH2F* fhElossVsBar[N_TOFD_HIT_PLANE_MAX];
    TH2F* fh_los_pos;
    TH2F* fhChargevsTof;
    TH2F* fhChargevsPos;
    TH2F* fhAverageCharge;
	TH1F* fhEloss[N_TOFD_HIT_PLANE_MAX];
	TH1F* fhChargePlane[N_TOFD_HIT_PLANE_MAX];
	TH1F* fhLuminosity[N_TOFD_HIT_PLANE_MAX][N_TOFD_HIT_PADDLE_MAX];
	TH1F* fhSqrtToT[N_TOFD_HIT_PLANE_MAX][N_TOFD_HIT_PADDLE_MAX];
	TH2F* fhPosToT[N_TOFD_HIT_PLANE_MAX];
	TH2F* fhPosDiff[N_TOFD_HIT_PLANE_MAX];

  public:
    ClassDef(R3BTofdCal2HitS473, 1)
};

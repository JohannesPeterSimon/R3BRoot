...
#ifndef R3BTOFDCAL2HISTOS473_H
#define R3BTOFDCAL2HISTOS473_H
...
class R3BTofdCal2HistoS473 : public FairTask
{
  ...
  public:
     ...
     */
    R3BTofdCal2HistoS473(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTofdCal2HistoS473();
  ...
  private:
	...
	TClonesArray* fCalItemsLos;		/**< Array with cal items from LOS. */
  ...
  public:
    ClassDef(R3BTofdCal2HistoS473, 1)
};

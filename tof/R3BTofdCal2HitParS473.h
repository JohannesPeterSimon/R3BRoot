...
#ifndef R3BTOFDCAL2HITPARS473_H
#define R3BTOFDCAL2HITPARS473_H
...
#endif
class R3BTofdCal2HitParS473 : public FairTask
{
  ...
  public:
     ...
     */
    R3BTofdCal2HitParS473(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTofdCal2HitParS473();
	...
	/**
	 * Method to apply smiley function instead of double exp
	 */
	inline void SetTofdSmiley(Bool_t yn) {fTofdSmiley = yn; }
    /**
	 * Setting the lower ToT boundary for position calibration
	 */
	inline void SetTofdTotLow(Double_t totLow) {fTofdTotLow = totLow; }
	/**
	 * Setting the higher ToT boundary for position calibration
	 */
     ...
     */
    virtual Double_t walk(Double_t Q, Double_t p1, Double_t p2, Double_t p3, Double_t p4, Double_t p5);
	...
	/**
	 * Method for calculation of ToTOffset
	 */
	virtual void calcToTOffset(Double_t TotLow, Double_t TotHigh);
	/**
	 * Method for calculation of attenuation parameter
	 */
	virtual void calcLambda(Double_t TotLow, Double_t TotHigh);
	/**
	 * Method for smiley calculation of position dependence of scintillator
	 */
	virtual void Smiley(TH2F* histo, Double_t min, Double_t max, Double_t*);
	/**
	 * Sets walk parameters to fixes values.
	 */
  ...
  public:
    ClassDef(R3BTofdCal2HitParS473, 1)
};
